...
class SiteSettingsControllerTest < ActionController::TestCase
  ...
  test "should create site_setting" do
    assert_difference('SiteSetting.count') do
      post :create, site_setting: { favicon: @site_setting.favicon, logo: @site_setting.logo, site_name: @site_setting.site_name }
    end
  ...
  test "should update site_setting" do
    patch :update, id: @site_setting, site_setting: { favicon: @site_setting.favicon, logo: @site_setting.logo, site_name: @site_setting.site_name }
    assert_redirected_to site_setting_path(assigns(:site_setting))
  end
