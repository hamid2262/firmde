...
class SlideshowsControllerTest < ActionController::TestCase
  ...
  test "should create slideshow" do
    assert_difference('Slideshow.count') do
      post :create, slideshow: { background: @slideshow.background, delay: @slideshow.delay, masterspeed: @slideshow.masterspeed, slotamount: @slideshow.slotamount, transition: @slideshow.transition }
    end
  ...
  test "should update slideshow" do
    patch :update, id: @slideshow, slideshow: { background: @slideshow.background, delay: @slideshow.delay, masterspeed: @slideshow.masterspeed, slotamount: @slideshow.slotamount, transition: @slideshow.transition }
    assert_redirected_to slideshow_path(assigns(:slideshow))
  end
