class CrawlersController < ApplicationController
  ...
  def add_to_list
    vs = ViewStatistic.find params[:view_statistic_id]
    Crawler.create(ip: vs.viewer_ip, head: vs.head)
    
    Rails.cache.delete([:crawlers, :all])
  ...
  private
    ...
    def crawler_params
      params.require(:crawler).permit(:ip, :head)
    end
end
